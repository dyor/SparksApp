            ...
            >
                <View style={{ gap: 15, paddingBottom: 20 }}>
                    <Text style={[styles.mixerHelpText, { color: colors.textSecondary }]}>
                        ...
                        • <Text style={{ fontWeight: 'bold', color: colors.text }}>Singing Mode:</Text> Adds a melodic vibrato effect that syncs with the song rhythm. {"\n\n"}
                        • <Text style={{ fontWeight: 'bold', color: colors.text }}>Accents & Styles:</Text> Select a specific performance theme (e.g. British, Texan, Blues) for AI songs.
                    </Text>
                </View>
            </CommonModal>
        </View>
