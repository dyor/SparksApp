...
const SongMakerService = {
    ...
    generateAISong: async (userPrompt: string, accent: string = 'default'): Promise<Omit<MusicAnalysisResult, 'vocalUri'>> => {
        ...
        const prompt = `
            ...
            - YOU MUST PROVIDE 1 LYRIC LINE EVERY BAR (OR EVERY 2 BARS FOR SLOWER PARTS).
            ...
            - For example, at 120 BPM:
                ...
                Line 3 (Bar 2): 4s
                Line 4 (Bar 3): 6s
            - Keep timings very tight. Do NOT add large gaps between lines.
...
Generated by Sparks App
    ...
    const playSong = async () => {
        ...
        try {
            ...
            const introDelay = playIntro ? (beatDuration * 4) : 0; // 1 bar (4 beats) intro, was 8
