...
export const BigDennySpark: React.FC<BigDennySparkProps> = ({
  showSettings,
  onCloseSettings,
  onStateChange,
}) => {
  ...
  // Load saved state
  useEffect(() => {
    const savedData = getSparkData('big-denny');
    if (savedData) {
  ...
  // Save state
  useEffect(() => {
    setSparkData('big-denny', { mode, gameState });
  }, [mode, gameState]);
  ...
  if (mode === 'setup') {
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.header}>Big Denny Setup 🏌️</Text>
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Big Denny 🏌️</Text>
