      ...
      <SettingsContainer>
        <SettingsScrollView>
          ...
          <View style={{ padding: 20 }}>
            ...
            >
              A classic word guessing game. Player 1 enters a word, then players
              take turns guessing letters. Wrong guesses build the hangman!
            </Text>
          </View>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.content}>
        ...
        {/* Word Display */}
        <View style={styles.wordContainer}>{renderWordDisplay()}</View>
